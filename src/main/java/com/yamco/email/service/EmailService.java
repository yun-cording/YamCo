	...
	public void sendEmail(Member_VO mvo, String fromMail) {
		...
		try {			
			...
			sendMail.setText("" 
						...
						+ "<tr><td><h4 style='font-size: 20px; margin:3% auto;'><span style=\"font-size: 20px;\">변경하러 가기</span> | <span style=\"color: green;\"><a href='http://nohssam.shop/go_new_pw.do?m_id=" + mvo.getM_id() + "' style='text-decoration:none; color:green;'>Link</span> | </h4></td></tr>"
						+ "<tr><td></td></tr>"
