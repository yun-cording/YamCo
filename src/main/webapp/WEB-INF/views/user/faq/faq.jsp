...
<body>
	<div id="mydiv">		
		...
		<div id="content">
			...
			<div id="q_title">
				<span id="q_title_t">레시피에 사용되는 재료들을 확인하고 싶어요. 어떻게 찾을 수 있을까요?</span>
				<img class="arrow" id="a_2" src="/resources/images/arrow_down.png">
				</div>
				<div id="answer" class="a2">
				<span id="a_text_2">각 레시피 페이지에서 '재료' 섹션을 확인하시면 필요한 재료들의 목록과 양을 찾을 수 있습니다.
				</span>
			</div>
				<div id="q_title">
				<span id="q_title_t">특정 식재료가 포함된 레시피를 추천해주세요.</span>
		...
		<div id="q_title">
				<span id="q_title_t">레시피의 난이도에 따라 분류되는 기준이 어떻게 되나요?</span>
		...
		<div id="answer" class="a4">
			...
			<div id="q_title">
				<span id="q_title_t">레시피에 나오는 양은 몇 인분 기준인가요?</span>
				<img class="arrow" id="a_5" src="/resources/images/arrow_down.png">
		</div>
		<div id="answer" class="a5">
				<span id="a_text_5">대부분의 레시피는 2~4인분을 기준으로 작성되어 있습니다. 그러나 원하는 만큼 배수로 조절하여 요리할 수도 있습니다.
				</span>
			</div>
			<div id="q_title">
				<span id="q_title_t">레시피에 나와있는 조리 순서가 이해되지 않아요.</span>
				<img class="arrow" id="a_6" src="/resources/images/arrow_down.png">
		</div>
		<div id="answer" class="a6">
				<span id="a_text_6">레시피 페이지에서 각 단계별로 제공되는 설명을 참고하시면 됩니다. 어려운 부분이 있으면 그 부분을 더 자세히 설명해드릴 수도 있습니다.
				</span>
			</div>
		<div id="q_title">
				<span id="q_title_t">레시피의 영양 정보를 확인하려면 어떻게 해야 하나요?</span>
				<img class="arrow" id="a_7" src="/resources/images/arrow_down.png">
		</div>			
		<div id="answer" class="a7">
				<span id="a_text_7">대부분의 레시피에는 칼로리, 단백질, 지방 등의 영양 정보가 포함되어 있습니다. 각 레시피 페이지의 하단에 해당 정보를 확인할 수 있는 링크가 있을 것입니다.
				</span>
			</div>
		 </div>
