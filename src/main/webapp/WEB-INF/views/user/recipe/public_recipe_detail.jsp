...
.comment_content{
	/* span에서 margin-left 한번더 줘서 글자가 이상하게 */
	font-size: 16px;
}
				...
				<div>
					...
					<div id="nutrition" style="margin-top: 430px;">
						...
						<div style="width: 400px; height: 230px; text-align: center; margin-left: 780px; margin-top: -280px; position: relative; top : -170px;">
							<p style="font-size: 32px;"><strong>총 열량 : ${puvo.info_eng} 159kcal</strong></p>
							<p style="font-size: 32px;"><strong>나트륨 : ${puvo.info_na} 244mg</strong></p>
							<p style="font-size: 32px;"><strong>탄수화물 : ${puvo.info_car} 12g</strong></p>
							<p style="font-size: 32px;"><strong>단백질 : ${puvo.info_pro} 100g</strong></p>
							<p style="font-size: 32px;"><strong>지방 : ${puvo.info_fat} 30g</strong></p>
						</div>
					...
					<div style="margin-top: 0px; margin-bottom: 100px;">
						<img src="resources/images/cooking.png" style="width:135px; height:135px; position: relative; margin-left: 565px; margin-top: 100px;">
						<span style="font-size:32px; position: relative; top: 50px; left-margin: -100px; left: -142px;"><strong>조리 과정</strong></span>
						<div style="text-align:center; margin-top: 500px;">
							<c:forEach var="k" begin="3" end="7">
								<!-- 이미지 넣자 (196 x 130px)  -->
								<!-- 이미지 사이즈 320으로 했는데, 너무 깨지면 바꿔버리자 -->
									<%-- MANUAL_IMG0${k} 이런 형태임! --%>
								<div style="margin-top: -100px; position:relative; left: -500px;">
									<img src="resources/images/public_sample${k}.png" style="width:196px; position: relative; margin-left: 565px; top: -300px;">
									<!-- 조리방법 -->
									<div style="margin-left: 1100px; position: relative; top: -400px; width: 470px; height: 200px;">
										<p style="font-size: 14px;">${puvo.manual01} 1. 부추는 깨끗이 씻어 물기를 제거하고, 5cm 길이로 썰고 부추에 날콩가루를 넣고 고루 섞이도록 버무린다.</p>
										<c:if test="${k == 3}">
